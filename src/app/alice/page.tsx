                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="quest-card overflow-hidden slide-up relative group" style={{ animationDelay: "0.5s" }}>
                            ...
                            <div className="absolute bottom-4 left-4 right-4 z-10 flex flex-col items-center">
                                ...
                                <p className="text-xs text-fuchsia-300 font-bold bg-black/60 px-2 py-0.5 rounded-full mt-1 border border-white/10 backdrop-blur-sm shadow-lg">Risorsa Ufficiale</p>
                            </div>
                        </div>
                    </div>
                </div>
