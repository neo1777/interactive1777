                    ...
                    <div className="flex flex-col gap-6">
                                ...
                                {[
                                    ...
                                    <div key={sketch.label} className="text-center group">
                                        <div className="w-14 h-14 relative mx-auto mb-2 bg-black/40 rounded-xl border border-white/5 p-1 group-hover:border-fuchsia-500/40 transition-colors shadow-inner">
                                            <ClickableImage src={sketch.src} alt={sketch.label} fill className="object-contain" />
                                        </div>
                        ...
                        >
                            <div className="w-full h-[180px] relative bg-black/80">
                                <ClickableImage src={getAssetPath("/assets/art_director_workbook_cover.png")} alt="Manuale dell'Art Director" fill className="object-cover opacity-60 group-hover:opacity-100 transition-opacity duration-500 group-hover:scale-105" />
