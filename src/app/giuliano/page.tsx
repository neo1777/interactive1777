        ...
        <div className="flex flex-col items-center min-h-screen p-4 sm:p-8 relative z-10 w-full max-w-7xl mx-auto">
            ...
            <div className="w-full">
                ...
                <div className="quest-card overflow-hidden mb-8 slide-up relative min-h-[300px] flex flex-col justify-end p-6 sm:p-10 border-emerald-500/30 shadow-[0_0_50px_rgba(16,185,129,0.15)] rounded-2xl">
                    <ClickableImage
                        src={getAssetPath("/assets/level_designer_banner.png")}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 xl:gap-8">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <a 
                            href={getAssetPath("/docs/giuliano_level_designer_v2.pdf")} 
                            download 
                            className="quest-card overflow-hidden slide-up relative group cursor-pointer block hover:border-emerald-500/50 transition-all border-white/5" 
                            style={{ animationDelay: "0.5s" }}
                        >
                            <div className="w-full h-[180px] relative bg-black/80">
                                <ClickableImage src={getAssetPath("/assets/level_designer_workbook_cover.png")} alt="Manuale del Level Designer" fill className="object-cover opacity-60 group-hover:opacity-100 transition-opacity duration-500 group-hover:scale-105" />
                            ...
                            <div className="absolute bottom-4 left-4 right-4 z-10 flex flex-col items-center">
                                ...
                                <p className="text-xs text-emerald-300 font-bold bg-black/60 px-2 py-0.5 rounded-full mt-1 border border-white/10 backdrop-blur-sm shadow-lg flex items-center gap-1.5">
