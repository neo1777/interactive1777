                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        >
                            <div className="w-full h-[180px] relative bg-black/80">
                                <Image src={getAssetPath("/assets/level_designer_workbook_cover.png")} alt="Manuale del Level Designer" fill className="object-cover opacity-60 group-hover:opacity-100 transition-opacity duration-500 group-hover:scale-105" />
